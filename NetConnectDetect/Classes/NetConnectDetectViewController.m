//
//  NetConnectDetectViewController.m
//  NetConnectDetect
//
...
@implementation NetConnectDetectViewController
...
{
    [super viewDidLoad];
	NetConnectDetectAppDelegate *delegate = [[UIApplication sharedApplication] delegate];
